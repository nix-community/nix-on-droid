...

{
  ...
  config = {
    ...
    environment.etc = {
      "ssh/ssh_known_hosts".text = knownHostsText;
    } // lib.optionalAttrs (cfg.knownHosts != { } || cfg.knownHostsFiles != [ ]) {
      "ssh/ssh_config".text = "GlobalKnownHostsFile ${builtins.concatStringsSep " " knownHostsFiles}\n";
    };
