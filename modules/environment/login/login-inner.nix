...
writeText "login-inner" ''
  ...
  # Add Android system tools to PATH — the bundled busybox only provides sh.
  # Inside proot, / is the nix prefix and /android is the real Android root.
  export PATH="/android/system/bin:$PATH"
